...
Unitil now you have been resonsible for running the tests. If you're disciplined then you ran them (and fixed errors) before you committed new code to your repository. There is an easier way though, with continuous integration (or CI) of tests. 
